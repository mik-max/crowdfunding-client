          ...
          <div className='bg-[#1c1c24] flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4'>
               ...
               <form onSubmit={handleSubmit} className = "w-full mt-[65px] flex flex-col gap-[30px]">
                    <div className='flex flex-wrap gap-[40px]'>
                         <FormField labelName = "Your Name" placeholder = "Mike code" inputType = "text" value = {form.name} handleChange = { (e) => handleFormFieldChange('name', e)}  />
                    ...
                    <div className="w-full flex justify-start items-center p-4 bg-[#8c6dfd] h-[120px] rounded-[10px]">
                         ...
                         <h4 className="font-epilogue font-bold text-[24px] text-white ml-[20px] sm:text-[16px]">You will get 100% of the raised amount</h4>
                    </div>
                    <div className='flex flex-wrap gap-[40px]'>
